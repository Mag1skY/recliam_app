...
//        verifyCode = bundle.getString("verifyCode");
    ...
    protected void initView() {
        ...
        etInteretProduct = (MyEditText) findViewById(R.id.interet_product_input_et);
        ...
        etCompanyAddress = (MyEditText) findViewById(R.id.company_address_input_et);
        etCompanyType = (MyEditText) findViewById(R.id.company_type_input_et);
